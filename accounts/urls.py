...
urlpatterns = [
    ...
    path('admin-panel/reset-demo/', views.admin_reset_demo, name='admin_reset_demo'),
    ...
    path('schedule/', views.patient_schedule, name='patient_schedule'),
    ...
    path('test/db-view/', views.test_database_view, name='test_database_view'),
