...
class User(AbstractUser):
    ...
    telegram_link_token = models.CharField(max_length=64, default=None, blank=True, null=True, help_text='One-time token used to connect a Telegram account')
    telegram_active = models.BooleanField(default=False, help_text='This account is the active one for its shared Telegram chat')
...
class PatientRecord(models.Model):
    ...
    def __str__(self):
        return f"Record: {self.patient.full_name} ({self.date_added})"
